//Clase que implementa el filtro Recursivo a Colores
export default class RecursivoColor {
    ...
    recursivoColor(color) {
        this.width=this.modelo.nuevoCanvas.width;
        this.height=this.modelo.nuevoCanvas.height;

        //Leemos los datos de la imagen.
        var ponPixel2 = this.modelo.nuevoCtx.getImageData(0, 0, this.modelo.nuevoCanvas.width, this.modelo.nuevoCanvas.height)
        var valor2 = ponPixel2.data
        ...
        while (this.ejeX < this.width) {
            ...
            while (this.ejeY < this.height) {
                ...
                if (color) this.colorr(red, green, blue);
    ...
    colorr(r,g,b) {
        this.apply_function_per_pixel(function(red, green, blue){
            return {red :red & r, green: green & g, blue: blue & b};
        });
    }
}