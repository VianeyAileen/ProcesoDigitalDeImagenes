//Clase que implemeta el filtro Semitiono3
export default class Semitono3 {
    ...
    //Implementación del filtro con semitonos usando una cuadrícula de 2x2
    async semiTono3() {
...
*El tiempo de procesamiento de la imagen dependerá del tamaño del pixel*`));
        ...
        //Imágnes de semitonos usando una cuadrícula de 2x2
        this.imagenes = ["../ProcesoDigitalDeImagenes/imagenes-semitonos/c4.jpg","../ProcesoDigitalDeImagenes/imagenes-semitonos/c3.jpg", "../ProcesoDigitalDeImagenes/imagenes-semitonos/c2.jpg", "../ProcesoDigitalDeImagenes/imagenes-semitonos/c1.jpg", "../ProcesoDigitalDeImagenes/imagenes-semitonos/c0.jpg"]
